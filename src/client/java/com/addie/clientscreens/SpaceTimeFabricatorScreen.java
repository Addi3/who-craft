...
public class SpaceTimeFabricatorScreen extends HandledScreen<SpaceTimeFabricatorScreenHandler> {
    private static final Identifier TEXTURE = new Identifier(WhoCraft.MOD_ID, "textures/gui/container/space_time_fabricator.png");
    ...
    public SpaceTimeFabricatorScreen(SpaceTimeFabricatorScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    protected void drawMouseoverTooltip(DrawContext context, int x, int y) {
        ...
        if (this.canCraft) {
            ...
            List<FabricationRecipe> list = this.handler.getAvailableRecipes();
